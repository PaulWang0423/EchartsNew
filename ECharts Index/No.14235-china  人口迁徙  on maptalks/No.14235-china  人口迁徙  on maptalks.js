var url = '/asset/get/s/data-1491570628388-HkhpkGr6x.json';
var geoCoord = {
...
//线路获取
function getLineCoord(fromname, toname) {
...
option = {
    maptalks3D: {
        center: [31.30150538026905, 120.63955565318601].reverse(),
        zoom: 4,
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            data.allLine.sort(function(a, b) {
                ...
                option.series[0].data.push(getLineCoord(line.start, line.end));
                //option.series[1].data.push(getLineCoord(line.start, line.end));
            });
