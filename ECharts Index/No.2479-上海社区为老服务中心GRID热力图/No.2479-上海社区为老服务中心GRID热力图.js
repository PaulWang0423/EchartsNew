...
function initMapv() {
    ...
    var options = {
        ...
        globalAlpha: 1,
        gradient: {
            0.1: "rgba(200, 20, 60,0.1)",
            0.2: "rgba(200, 20, 60,0.2)",
            0.3: "rgba(200, 20, 60,0.3)",
            0.4: "rgba(200, 20, 60,0.4)",
            0.5: "rgba(200, 20, 60,0.5)",
            0.6: "rgba(200, 20, 60,0.6)",
            0.7: "rgba(200, 20, 60,0.7)",
            0.8: "rgba(200, 20, 60,0.8)",
            0.9: "rgba(200, 20, 60,0.85)",
            1.0: "rgba(200, 20, 60,0.9)"
        },
        label: {
            show: true,
            fillStyle: 'white',
