//为PandaBI中自定义图表的最佳实践案例
//2021/08/01 by cai.yu@datatom.com
...
//datasource是核心绘图数据
//在PandaBI自定义图表中，需要取消注释以下片段，注释静态数据
// var datasource = dataSet.slice(0, 7).map(item => {
//     return {
//         name: item[0],
...
//legenddata是图例数据
//在PandaBI自定义图表中，需要取消注释以下片段，注释静态数据
// var legenddata = dataSet.slice(0, 7).map(item => {
//     return item[0]
// })
var legenddata = ["酒精", "护目镜", "手套", "口罩", "测温枪", "防护服", "消毒液"]
