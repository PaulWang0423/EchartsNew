...
// 贵州 --> 缅北 数据
var GZData = [
    [{name:'贵州'}, {name:'测试1',value:95}],
    [{name:'贵州'}, {name:'测试2',value:90}],
    [{name:'贵州'}, {name:'测试3',value:90}],
    [{name:'贵州'}, {name:'测试4',value:90}],
    [{name:'贵州'}, {name:'测试5',value:90}],
    [{name:'贵州'}, {name:'测试6',value:90}],
    [{name:'贵州'}, {name:'测试7',value:90}],
    [{name:'贵州'}, {name:'测试8',value:90}],
];
// 贵州 --> 云南 数据
var YNData = [
    [{name:'贵州'}, {name:'云南1',value:95}],
    [{name:'贵州'}, {name:'云南2',value:90}],
    [{name:'贵州'}, {name:'云南3',value:90}],
    [{name:'贵州'}, {name:'云南4',value:90}],
    [{name:'贵州'}, {name:'云南5',value:90}],
    [{name:'贵州'}, {name:'云南6',value:90}],
];
...
var geoCoordMap = {
    '贵州': [106.6992,26.7682],
    // 云南点位
    '云南1': [103.92334,23.936303],
    '云南2': [99.836426,25.928652],
    '云南3': [100.759277,22.116429],
    '云南4': [101.154785,22.034982],
    '云南5': [103.967285,23.170914],
    '云南6': [98.166504,24.577347],
    // 缅北点位
    '测试1': [97.925291,21.165868],
    '测试2': [102.902097,18.437299],
    '测试3': [102.341309,21.667891],
    '测试4': [105.021973,21.381728],
    '测试5': [97.727051,27.186484],
    '测试6': [97.727051,27.186484],
    '测试7': [105.8638,20.560247],
    '测试8': [97.990723,26.598594]
};

var color = ['#a6c84c', '#ffa022', '#46bee9'];
var colors = ["255,49,68", "0,213,255", "0,204,102", "187,51,255", "0,102,255"];
var series = [{
        type: 'map',
        map: 'world',
        roam: false,
        ...
        zlevel: 1
            ...
            show: true,
            //调整以下3个配置项与页面地图重合
            // aspectScale: .75,			//echarts地图的长宽比（就是胖瘦）
            center: [115.97, 29.71], //设置可见中心坐标，以此坐标来放大和缩小
            top: '11.5%',
        left: '9.3%',
            zoom: .85, //放大级别
            tooltip: {
...
[['贵州', GZData],['贵州', YNData]].forEach(function (item, i) {
    let name = '缅北'
    i === 1 ? name = "云南" : name ="缅北"
    series.push(
        {
        ...
        lineStyle: {
                normal: {
                    color: {
                        ...
                        colorStops: [{
                            offset: 0,
                            color: 'rgba(' + colors[i] + ',0.1)' // 0% 处的颜色
                        }, {
                            offset: 1,
                            color: 'rgba(' + colors[i] + ',1)' // 100% 处的颜色
                        }],
