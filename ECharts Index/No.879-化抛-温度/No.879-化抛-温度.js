//数据
var XName = ['17','22','16','8','22','4','19','11','2','3'
];
var data1 = [82,80.5,80.8,78.2,80.9,82.3,80.6,80.4,81.2,80.8];
var data2 = [18.3,18.3,18.3,18.3,18.3,18.3,18.3,18.3,18.3,18.3,18.3,18.3];
var img = [
    ...
    series: [
        {
                ...
                normal: {
                    ...
                    position: [-5,-20],
                     formatter: function (param) {
                        if (param.data >=81 ||  param.data <=79) {
                            return '{a|' + param.data + '}';
                        }  else {
                            return '{b|' + param.data + '}';
                        }
            ...
            normal: {
                ...
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                        offset: 0,
                        color: "rgba(5,203,253,.3)"


                    },
                    {
                        offset: 1,
                        color: "rgba(5,203,253, 0)"
                    }
                ], false),
                shadowColor: 'rgba(5,203,253, 0.5)', //阴影颜色
