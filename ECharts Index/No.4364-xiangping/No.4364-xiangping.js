...
var aData = [ 
  ...
  [{name:'上海'},{name:'湖北',value:5} ],
  [{name:'上海'},{name:'广州',value:5} ],
  [{name:'上海'},{name:'台州',value:5} ],
  [{name:'上海'},{name:'福建',value:5} ],
  [{name:'西安'},{name:'北京',value:0} ],
  [{name:'西安'},{name:'西藏',value:5} ],
  [{name:'西安'},{name:'四川',value:5} ],
  [{name:'西安'},{name:'青海',value:5} ],
  [{name:'西安'},{name:'新疆',value:5} ],
  [{name:'北京'},{name:'哈尔滨',value:5} ],
  [{name:'北京'},{name:'山西',value:5} ],
  [{name:'北京'},{name:'内蒙古',value:5} ],
  ];
