...
option = {
    ...
    },
    {
        ...
        inRange: {
            color: ["#ea3223", "#f19d38", "#fffd61", "#8c25c4", "#3e69f6", "#80c84e"] //气泡配色
        }
    }
    ],
    geo3D: {
...

        {
            ...
            itemStyle: {
                ...
                color: function(params) {
                    ...
                    if (params.value[3] >= 0 && params.value[3] <= 19) {
                        return colors[0];
                    }
                    if (params.value[3] >= 20 && params.value[3] <= 39) {
                        return colors[1];
                    }
                    if (params.value[3] >= 40 && params.value[3] <= 59) {
                        return colors[2];
                    }
                    if (params.value[3] >= 60 && params.value[3] <= 79) {
                        return colors[3];
                    }
                    if (params.value[3] >= 8 && params.value[3] <= 99) {
                        return colors[4];
                    }
