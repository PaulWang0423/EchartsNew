...
const datas = [
    ...
    [{"name":"上海市"},{"name":"海门市","value":28}],
    [{"name":"上海市"},{"name":"襄阳市","value":28}],
    [{"name":"上海市"},{"name":"郑州","value":350}],
    [{"name":"上海市"},{"name":"南昌市","value":42}],
    [{"name":"上海市"},{"name":"潮州市","value":84}],
    [{"name":"上海市"},{"name":"乌鲁木齐市","value":14}],
    [{"name":"上海市"},{"name":"克拉玛依市","value":14}],
    [{"name":"上海市"},{"name":"文山州","value":14}],
    [{"name":"上海市"},{"name":"大理州","value":14}],
    [{"name":"上海市"},{"name":"云龙县","value":14}],
    [{"name":"上海市"},{"name":"南通市","value":14}],
    [{"name":"上海市"},{"name":"麻栗坡县","value":14}],
    [{"name":"上海市"},{"name":"乐平市","value":14}],
    [{"name":"上海市"},{"name":"宜春市","value":14}],
    // [{"name":"上海市"},{"name":"苏州市","value":14}],
    [{"name":"上海市"},{"name":"淮南市","value":14}],
    [{"name":"上海市"},{"name":"乌镇","value":14}],
    [{"name":"上海市"},{"name":"徐州","value":14}],
    [{"name":"上海市"},{"name":"石河子市","value":14}],
    [{"name":"上海市"},{"name":"六安市","value":14}],
    [{"name":"上海市"},{"name":"南陵县","value":14}],
    [{"name":"上海市"},{"name":"阜南县","value":14}],
    [{"name":"上海市"},{"name":"砀山县","value":14}],
    [{"name":"上海市"},{"name":"宜宾市","value":14}],
    [{"name":"上海市"},{"name":"蒙城县","value":14}],
    [{"name":"上海市"},{"name":"南通市","value":14}],
    [{"name":"上海市"},{"name":"楚雄彝族自治州","value":14}],
    ];
    ...
    series: [{
      ...
      data: labels.map((dataItem) => {
        return {
          ...
          itemStyle: {
            normal: {
              color: !dataItem.value ? '#68c624' : '#c12e34',
              textStyle:{
                  fontSize: '18px',
                  fontWeight: 'bold',
              }
