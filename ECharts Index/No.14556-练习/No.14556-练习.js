...
function load() {
    ...
    for (var i = 0; i < 24; i++) {
       ...
       {  j = (i +1+ hours) % 24;}
        ...
        (function(order,hour) {
            var url = "https://tools.bigkeer.cn/aqi/" + (hour == 04 ? "03"  : hour < 10 ? "0" + hour.toString() : hour.toString()) + ".json?ts=" + date.getTime().toString();
            $.ajax({
                url: url,
                datatype: "json",
                success: function(data) {
                    option.baseOption.timeline.data[order] = hour;
                    if(data.hasOwnProperty('error'))
                    {
                        option.options[order] = {series: [{
                                data: [],
