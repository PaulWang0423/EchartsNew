...
var opts = {
	...
	backgroundColor: '#ff8800',// 导出的图片背景色，默认使用 option 里的 backgroundColor
// 	excludeComponents: ['toolbox']  // 忽略组件的列表，例如要忽略 toolbox 就是 ['toolbox'],一般也忽略了'toolbox'这栏就够了
}
console.log( myChart.getDataURL(opts))
