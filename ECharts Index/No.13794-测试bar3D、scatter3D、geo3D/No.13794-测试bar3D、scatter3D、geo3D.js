...
var weatherIcons = {
    up: 'http://echarts.baidu.com/examples/data/asset/img/arrow-up.png',
    down: 'http://echarts.baidu.com/examples/data/asset/img/arrow-down.png'
};
let geoCoordMap = {
    "海门": [121.15, 31.89],
            ...
            label: {
                normal: {
                    ...
                    formatter: function(params) {
                        ...
                        for (var i = 0, len = gangdata.length; i < len; i++) {
                            var gdname = gangdata[i].name;
                            var gddata = gangdata[i].data;
                            var gddataname = gddata.name;
                            var gddatavalue = gddata.value;
                            if (paramsname == gdname) {
                                html += paramsname + "  " + gddataname + '\n';
                                html += paramsvalue + "  " + gddatavalue;
                            }
                        }
                        return html;
                        //return '{' + valueType + '|' + params.value + '} {' + icon + '|}';
                    },
                    position: 'inside',
                    backgroundColor: '#fff',
                    padding: [8, 10],
