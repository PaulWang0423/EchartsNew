...
echarts.registerMap('jsMap', provinceJson);
...
list.forEach((item) => {
    ...
    data.push({
        ...
        name: item.areaName,
        data: [item.Power, item.obability]
    })
    map.push({
        name: item.cityName,
        value: item.Power,
...
option = {
    ...
    tooltip: {
        ...
        formatter: function(params, ticket, callback) {
            return `1值：` + params.data.data[0] + `MW` + `<br/>` + `1率：` + params.data.data[1] + `%`;
        }
    },
    visualMap: {
        min: 0,
