option = {
    ...
    xAxis: {
        ...
        data: ['多项式回归3次方', '多项式回归2次方', 'SVM回归', 'LGBM算法', 'GBRT回归', '线性回归', '岭回归', '最小绝对收缩', '随机森林', 'knn回归', 'Bagging回归', 'Adaboost回归', '决策树', 'ExtraTree极端随机树回归']
    },
    yAxis: {
        min: 0.1,
        max: 0.9,
    ...
    series: [{
            ...
            data: [0.20871, 0.21305, 0.21324, 0.21893, 0.22147, 0.22395, 0.22395, 0.22931, 0.25080, 0.25539, 0.27141, 0.30684, 0.43603, 0.44938]
        },
        {
            name: 'R^2',
            type: 'line',
            ...
            data: [0.78270, 0.77817, 0.77798, 0.77206, 0.76942, 0.76682, 0.76682, 0.76125, 0.73888, 0.73409, 0.71741, 0.68052, 0.54601, 0.53211]
        },
        // {
        //     name:'700hPa',
        //     type: 'line',
