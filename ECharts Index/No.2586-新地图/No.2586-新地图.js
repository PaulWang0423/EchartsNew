...
var mapDatas = [
    ...
    },
    {
        areaCode: 120000,
                name: '天津市',
                value: [117.190182, 39.125596,85],
    },
    {
        areaCode: 150000,
                name: '内蒙古自治区',
                value: [111.670801, 40.818311,105],
    },
    {
        areaCode: 230000,
                name: '黑龙江省',
                value: [126.642464, 45.756967,85],
    },
    {
        areaCode: 540000,
                name: '西藏自治区',
                value: [91.132212, 29.660361,65],
    }
    ];
echarts.registerMap('chinaMap', chinaMap);
echarts.registerMap('chinaMapOutline', chinaMap);
echarts.registerMap('chinaMapOutline1', chinaMap);
echarts.registerMap('chinaMapOutline2', chinaMap);
option = {
    backgroundColor: '#000',
    tooltip: {
        trigger: 'item',
    ...
    visualMap:{
        ...
        type: "piecewise" ,
        pieces: [
            {min: 100}, // 不指定 max，表示 max 为无限大
            {min: 80, max: 100,itemStyle:{color:'#fff'}},
            {max: 80}     // 不指定 min，表示 min 为无限小（-Infinity）。
        ],
        color: ['rgba(234,61,61,0.68)', 'rgba(235,199,73,0.68)', 'rgba(60,213,224,.8)']
    },
    series: [
        {
            z: 2,
