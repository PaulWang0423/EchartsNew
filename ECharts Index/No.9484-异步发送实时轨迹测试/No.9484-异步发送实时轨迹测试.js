...
//通过循环生成series配置
var getSeries = function(showArr) {
    var series = [];
    [
        ['北京->上海', BJData],
        ['北京->南宁', SHData],
        ...
        series.push({
            name: item[0],
            type: 'lines',
            zlevel: showArr.indexOf(i) >= 0 ? 2 : 1,
            effect: {
                show: showArr.indexOf(i) >= 0,
                period: period,
                trailLength: 0.7,
                color: '#fff',
                symbolSize: 3,
...
setInterval(function() {
    ...
    myChart.setOption({series:getSeries([tmp])});
    
    setTimeout(function() {
         myChart.setOption({series:getSeries([])});
